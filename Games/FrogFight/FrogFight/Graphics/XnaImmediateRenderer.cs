...
namespace FrogFight.Graphics
{
  public class XnaImmediateRenderer(GraphicsDevice graphicsDevice) : IDisposable, IImmediateRenderer
  {
    ...
    private MonoGame.Extended.OrthographicCamera m_camera;
    ...
    public void Begin(MonoGame.Extended.OrthographicCamera camera, bool enableDepthBuffer, bool additiveBlend,
      bool cullCounterClockwise)
    {
      m_camera = camera;
      ...
      graphicsDevice.RasterizerState =
        cullCounterClockwise ? RasterizerState.CullCounterClockwise : RasterizerState.CullNone;
    ...
    public void Draw(in Matrix4x4 worldTransform, in Mesh mesh)
    {
      ...
      _effect.GraphicsDevice.DrawUserPrimitives(PrimitiveType.TriangleList, _xnaVerticesBuffer.InternalArray, 0,
        _xnaVerticesBuffer.Count / 3);
    }
