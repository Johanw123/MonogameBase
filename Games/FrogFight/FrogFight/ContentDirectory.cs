    ...
    public static class MoreShaders 
    {
     ...
     public static class Textures 
     {
      public static class frogpack_spritesheets 
      {
       ...
       {
         public static string frog_sheet_aseprite => "Textures/Game/frog_sheet.aseprite";
         public static string hero_png => "Textures/Game/hero.png";
        public static class Frog 
        {
          ...
          public static string frog_animations_hop_json => "Textures/Game/Frog/frog_animations_hop.json";
          public static string frog_animations_hop_png => "Textures/Game/Frog/frog_animations_hop.png";
          public static string frog_animations_lick_json => "Textures/Game/Frog/frog_animations_lick.json";
          public static string frog_animations_lick_png => "Textures/Game/Frog/frog_animations_lick.png";
        }
       }
