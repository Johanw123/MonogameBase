...
{
  public class JFLoggerTheme : SixteenNotBrightAnsiThemeTemplate
  {
    protected override string LevelDebug => LogTheme.Foreground(System.Drawing.Color.CornflowerBlue);
    protected override string LevelInformation => LogTheme.Foreground(System.Drawing.Color.ForestGreen);
